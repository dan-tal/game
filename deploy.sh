...
# version.js (afisat in footer, util ca sa recunosti ce build ruleaza; il
# citeste si sw.js, deci fiecare deploy instaleaza un service worker nou).
...
echo "self.APP_VERSION = '$VERSION';" > version.js
