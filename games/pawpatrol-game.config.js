...
var PawPatrolGameConfig = {
  ...
  // (daca poza nu s-a incarcat inca sau lipseste, ca la Ryder mai jos).
  CHARACTERS: [
    ...
    { key: 'ryder',    name: 'Ryder',    emoji: '🧑', image: null, color: '#2e7d32', vehicle: 'car' }
  ],
  ...
  // Ryder — asa cum a cerut parintele. Dupa aceea alegerea e aleatorie.
  FIRST_TARGET_KEY: 'ryder',
